<#-- @Overriden /web-framework-commons/config/alfresco/site-webscripts/org/alfresco/components/form/controls/date.ftl-->
...
<div class="form-field">
   ...
   <#elseif !multiValued>
      ...
      <#else>
         ...
         <#if disabled == false>
            <a id="${controlId}-icon"><img src="${url.context}/res/components/form/images/calendar.png" class="datepicker-icon" tabindex="0"/>
            </a>
             <div id="${controlId}" class="datepicker"   style="position: relative; z-index: 1000;"></div>
         </#if>
